    ...
    <v-card class="elevation-0">
            ...
            <v-col md="10" class="my-0 py-0">
                <v-card-title class="px-1 py-1 my-0">
                    <v-row no-gutters>
                        ...
                        <v-col md="auto" xs="6">
                            <!--Search-->
                            <v-text-field label="Enter" class="mr-4" v-model="searchProject" @change="searchval = searchProject"
        ...
        <v-row justify="center">
            <v-col md="10" class="v-scrolling-div py-0 my-0 overdueCardHeight">
                <TaskDataCollector :searchcall="searchval" :searchtask="searchtaskval" :Filter=filtervalue :DateRange="daterange" :StartDate="startdate" :EndDate="enddate" :ProjectName="projectname" :BeneficiaryName="beneficiaryname" :WorkflowName="workflowname" :Action="action" :FilterGUID="filterGUID"></TaskDataCollector>
                <TaskDataApprover :searchcall="searchval" :searchtask="searchtaskval" :Filter=filtervalue :DateRange="daterange" :StartDate="startdate" :EndDate="enddate" :ProjectName="projectname" :BeneficiaryName="beneficiaryname" :WorkflowName="workflowname" :Action="action" :FilterGUID="filterGUID"></TaskDataApprover>
                <TaskFinanceApprover :searchcall="searchval" :searchtask="searchtaskval" :Filter=filtervalue :DateRange="daterange" :StartDate="startdate" :EndDate="enddate" :ProjectName="projectname" :BeneficiaryName="beneficiaryname" :WorkflowName="workflowname" :Action="action" :FilterGUID="filterGUID"></TaskFinanceApprover>
                <Survey :searchcall="searchval" :searchtask="searchtaskval" :Filter=filtervalue :DateRange="daterange" :StartDate="startdate" :EndDate="enddate" :ProjectName="projectname" :BeneficiaryName="beneficiaryname" :WorkflowName="workflowname" :Action="action" :FilterGUID="filterGUID"></Survey>
                <SurveyApprover :searchcall="searchval" :searchtask="searchtaskval" :Filter=filtervalue :DateRange="daterange" :StartDate="startdate" :EndDate="enddate" :ProjectName="projectname" :BeneficiaryName="beneficiaryname" :WorkflowName="workflowname" :Action="action" :FilterGUID="filterGUID"></SurveyApprover>
