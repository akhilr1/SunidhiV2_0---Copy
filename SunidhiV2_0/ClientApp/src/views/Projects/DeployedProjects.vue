            ...
            <v-row class="px-4">
                <v-col>
                    <h3 class="text-left page-head">
                        <v-avatar color="white" size="20" class="elevation-1 mr-2 mb-1">
                            <v-icon size="15" color="primary">mdi mdi-file-document-box-plus-outline</v-icon>
                        </v-avatar>
                        Deployed Project
                    </h3>
                </v-col>
                <v-col md="auto">
                    <v-row>
                        ...
                        <v-btn id="AutoTest_IP45" height="39" color="success-btn" dark class="elevation-0 mr-4" @click="CreateProjectDialog=true" v-bind:disabled ="!screenAccess">Create Project</v-btn>
                        ...
                        <v-menu offset-y transition="scroll-y-transition" v-bind:disabled ="!screenAccess">
                            ...
                            <v-list color="white" light="" width="auto" max-width="250" class="action-button-list">
                                ...
                                <v-list-item id="AutoTest_IP46" @click.stop="fnBulkRemoveClick()">
                                    <v-list-item-icon>
                            ...
                            <v-dialog v-model="RemoveBulkProjectDailog" width="800">
                                <v-card>
                                    <v-card-title primary-title class="page-head py-4">
                                        ...
                                        Remove Project
                                        <v-spacer></v-spacer>
                                        <v-btn id="AutoTest_IP47" text="" @click="RemoveBulkProjectDailog=false">
                                                    ...
                                                    <v-container fluid class="pt-0">
                                                        <v-row>
                                                            ...
                                                            <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                                <Secondary-Button id="AutoTest_IP48" class="btn-122x36 mr-4" title="Remove" @click.native="DeleteProject(1)"></Secondary-Button>
                                                                <Default-Button-Outlined id="AutoTest_IP49" class="btn-122x36" title="Cancel" @click.native="RemoveBulkProjectDailog=false"></Default-Button-Outlined>
                                                            </v-col>
                                                        </v-row>
                                                    </v-container>
                                                </v-col>
                        ...
                        <template v-slot:item.Actions="{item}">
                            <v-menu close-on-content-click offset-y left transition="scroll-y-transition" v-bind:disabled ="!screenAccess">
                                ...
                                <v-list color="white" light width="auto" class="action-button-list">
                                    <v-list-item id="AutoTest_IP50" @click.stop="" link :to="{ name: 'ManageProjectDetails', query: { WsID: WorkspaceID,Access:RWAccess, InitID: InitiativeId, ProjID: item.ProjectId,Type:'Initiative'  } }">
                                        <v-list-item-icon>
                                    ...
                                    <v-list-item id="AutoTest_IP51" link @click.stop="GetProjectID(item.ProjectId,item.ProjectName),ArchiveDailog=true,ProjectName=item.ProjectName">
                                        <v-list-item-icon>
                                    ...
                                    <v-list-item id="AutoTest_IP52" link @click.stop="GetProjectID(item.ProjectId,item.ProjectName),ForceCompleteDailog=true,ProjectName=item.ProjectName">
                                        <v-list-item-icon>
                                    ...
                                    <v-list-item id="AutoTest_IP53" link="" @click.stop="GetProjectID(item.ProjectId,item.ProjectName),RemoveProjectDailog=true,ProjectName=item.ProjectName">
                                        <v-list-item-icon>
                                            <v-icon>mdi-trash-can-outline</v-icon>
                                        </v-list-item-icon>
                                        <v-list-item-content>
                                ...
                                <v-dialog v-model="ArchiveDailog" width="800">
                                    <v-card>
                                        <v-card-title primary-title class="page-head py-4">
                                            ...
                                            Archive Project
                                            <v-spacer></v-spacer>
                                            <v-btn id="AutoTest_IP54" text="" @click="ArchiveDailog=false">
                                                <v-icon color="#707070" size="15">mdi-close</v-icon>
                                            </v-btn>
                                        </v-card-title>
                                        <v-card-text class="pt-0">
                                                    ...
                                                    <v-col cols="12" md="12" class="pt-0">
                                                        <v-container fluid class="pt-0">
                                                            <v-row>
                                                                ...
                                                                <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                                   <Secondary-Button id="AutoTest_IP55" class="btn-122x36 mr-4" title="Archive" @click.native="ChangeProjectStatus('Archived')"></Secondary-Button>
                                                                   <Default-Button-Outlined id="AutoTest_IP56" class="btn-122x36" title="Cancel" @click.native="ArchiveDailog=false"></Default-Button-Outlined>
                                                                </v-col>
                                                            </v-row>
                                                        </v-container>
                                                    </v-col>
                                ...
                                <v-dialog v-model="ForceCompleteDailog" width="800">
                                    <v-card>
                                        <v-card-title primary-title class="page-head py-4">
                                            ...
                                            Force Complete
                                            <v-spacer></v-spacer>
                                            <v-btn id="AutoTest_IP57" text="" @click="ForceCompleteDailog=false">
                                                <v-icon color="#707070" size="15">mdi-close</v-icon>
                                            </v-btn>
                                        </v-card-title>
                                        <v-card-text class="pt-0">
                                                    ...
                                                    <v-col cols="12" md="12" class="pt-0">
                                                        <v-container fluid class="pt-0">
                                                            <v-row>
                                                                ...
                                                                <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                                  <Secondary-Button id="AutoTest_IP58" class="btn-122x36 mr-4" title="Confirm" @click.native="ChangeProjectStatus('Completed')"></Secondary-Button>
                                                                  <Default-Button-Outlined id="AutoTest_IP59" class="btn-122x36" title="Cancel" @click.native="ForceCompleteDailog=false"></Default-Button-Outlined>
                                                                </v-col>
                                                            </v-row>
                                                        </v-container>
                                                    </v-col>
                                ...
                                <v-dialog v-model="RemoveProjectDailog" width="800">
                                    <v-card>
                                        <v-card-title primary-title class="page-head py-4">
                                            ...
                                            Remove Project
                                            <v-spacer></v-spacer>
                                            <v-btn id="AutoTest_IP60" text="" @click="RemoveProjectDailog=false">
                                                <v-icon color="#707070" size="15">mdi-close</v-icon>
                                            </v-btn>
                                        </v-card-title>
                                        <v-card-text class="pt-0">
                                                    ...
                                                    <v-col cols="12" md="12" class="pt-0">
                                                        <v-container fluid class="pt-0">
                                                            <v-row>
                                                                ...
                                                                <v-col>
                                                                    <h4 class="text-center heading-3">
                                                                      <v-avatar  class="mr-2 elevation-1" color="#fff" size="40">
                                                                        <v-icon color="#707070" size="25">mdi-file-document-box-plus-outline</v-icon>
                                                                      </v-avatar>
                                                                        {{ProjectName}}
                                                                    </h4>
                                                                </v-col>
                                                                ...
                                                                <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                                  <Secondary-Button id="AutoTest_IP61" class="btn-122x36 mr-4" title="Remove" @click.native="DeleteProject(2)"></Secondary-Button>
                                                                  <Default-Button-Outlined id="AutoTest_IP62" class="btn-122x36" title="Cancel" @click.native="RemoveProjectDailog=false"></Default-Button-Outlined>
                                                                </v-col>
                                                            </v-row>
                                                        </v-container>
                                                    </v-col>
                ...
                <v-col cols="12" sm="12" md="12">
                    <v-row :justify="justifyCenter">
                        <v-col md="12" class="text-center">
                            ...
                            <v-btn id="AutoTest_IP63" height="32" color="success-btn" dark class="elevation-0 mr-2" @click="" v-bind:disabled ="!screenAccess">
                                Create project
                            </v-btn>
                        </v-col>
                    </v-row>
            ...
            <v-dialog v-model="IsActiveToggleDialog" width="800">
                <v-card class="elevation-0">
                    <v-card-title primary-title class="page-head py-4">
                        ...
                        Change State
                        <v-spacer></v-spacer>
                        <v-btn id="AutoTest_IP64" text @click="IsActiveToggleDialog=false">
                            <v-icon color="#707070" size="15">mdi-close</v-icon>
                        </v-btn>
                    </v-card-title>
                    <v-card-text class="pt-0">
                                ...
                                <v-col cols="12" md="12" class="pt-0">
                                    <v-container fluid class="pt-0">
                                        <v-row>
                                            ...
                                            <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                <v-btn id="AutoTest_IP65" color="secondary elevation-0" class="mr-2" @click="ChangeState()">Change</v-btn>
                                                <v-btn id="AutoTest_IP66" outlined color="grey" @click="IsActiveToggleDialog=false, GetProjectListByInitID()">Cancel</v-btn>
                                            </v-col>
