                ...
                <v-col cols="4">
                    <h3 class="text-left page-head">
                        <v-avatar color="white" size="20" class="elevation-1 mr-2 mb-1">
                            <v-icon size="15" color="primary">mdi-file-document-box-minus-outline</v-icon>
                        </v-avatar>
                        Archived Project
                    </h3>
                </v-col>
                    ...
                    <v-row>
                        ...
                        <v-menu offset-y transition="scroll-y-transition" v-bind:disabled="!screenAccess">
                            ...
                            <v-list color="white" light="" width="auto" max-width="250" class="action-button-list">
                                ...
                                <v-list-item id="AutoTest_MP5" @click.stop="fnBulkRemoveClick()">
                                    <v-list-item-icon>
                            ...
                            <v-dialog v-model="RemoveBulkProjectDailog" width="800">
                                <v-card>
                                    <v-card-title primary-title class="page-head py-4">
                                        ...
                                        Remove Project
                                        <v-spacer></v-spacer>
                                        <v-btn id="AutoTest_MP6" text="" @click="RemoveBulkProjectDailog=false">
                                                    ...
                                                    <v-container fluid class="pt-0">
                                                        <v-row>
                                                            ...
                                                            <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                                <Secondary-Button id="AutoTest_MP7" class="btn-122x36 mr-4" title="Remove" @click.native="DeleteProject(1)"></Secondary-Button>
                                                                <Default-Button-Outlined id="AutoTest_MP8" class="btn-122x36" title="Cancel" @click.native="RemoveBulkProjectDailog=false"></Default-Button-Outlined>
                                                            </v-col>
                                                        </v-row>
                                                    </v-container>
                                                </v-col>
                ...
                <v-col cols="12" md="12" sm="12" xs="12" class="px-0">
                    <v-data-table :headers="ProjectTableheaders"
                        ...
                        <template v-slot:item.ProjectName="{ item }">
                            <!--<router-link class="text--default text-link" link="" :to="{ name: 'MyprojectsArchivedIndividual', query: { WsID: item.WorkspaceID,Access:RWAccess, InitID: item.InitiativeID, ProjID: item.ProjectId,AccessType:'MyProject' } }">
                      {{ item.ProjectName }}
                    </router-link>-->
                        ...
                        <template v-slot:item.Actions="{item}">
                            <v-menu close-on-content-click offset-y left transition="scroll-y-transition" v-bind:disabled="!screenAccess">
                                ...
                                <v-list color="white" light width="auto" class="action-button-list">
                                    <v-list-item id="AutoTest_MP9" link="" @click.stop="GetProjectID(item.ProjectId,item.ProjectName),UnarchiveDailog=true,ProjectName=item.ProjectName">
                                        <v-list-item-icon>
                                    ...
                                    <v-list-item id="AutoTest_MP10" link @click.stop="GetProjectID(item.ProjectId,item.ProjectName),GetProjectTemplateByprjtID(),GetProjectTheme()">
                                        <v-list-item-icon>
                                    ...
                                    <v-list-item id="AutoTest_MP11" link="" @click.stop="GetProjectID(item.ProjectId,item.ProjectName),RemoveProjectDailog=true,ProjectName=item.ProjectName">
                                        <v-list-item-icon>
                                            <v-icon>mdi-trash-can-outline</v-icon>
                                        </v-list-item-icon>
                                        <v-list-item-content>
                                ...
                                <v-dialog v-model="UnarchiveDailog" width="800">
                                    <v-card>
                                        <v-card-title primary-title class="page-head py-4">
                                            <v-avatar color="white" size="25" class="elevation-1 mr-2">
                                                <v-icon size="20" color="primary">mdi-file-undo-outline</v-icon>
                                            </v-avatar>
                                            Unarchive Project
                                            <v-spacer></v-spacer>
                                            <v-btn id="AutoTest_MP12" text="" @click="UnarchiveDailog=false">
                                                <v-icon color="#707070" size="15">mdi-close</v-icon>
                                            </v-btn>
                                        </v-card-title>
                                        <v-card-text class="pt-0">
                                                ...
                                                <v-row no-gutters>
                                                    <v-col cols="12" md="12" class="pt-0">
                                                        <v-container fluid class="pt-0">
                                                            <v-row>
                                                                <v-col cols="12" md="12" class="pt-0">
                                                                    <h4 class="text-center heading-3">Are you sure you want to Unarchive this project ?</h4>
                                                                </v-col>
                                                                <v-col>
                                                                    <h4 class="text-center heading-3">
                                                                        <v-avatar class="mr-2 elevation-1" size="40" color="#fff">
                                                                            <v-icon class="tmr-2" color="#707070" size="25">mdi-file-document-box-outline </v-icon>
                                                                        </v-avatar>
                                                                        {{ProjectName}}
                                                                    </h4>
                                                                </v-col>
                                                                ...
                                                                <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                                    <Secondary-Button id="AutoTest_MP13" class="btn-122x36 mr-4" title="Unarchive" @click.native="ChangeProjectStatus()"></Secondary-Button>
                                                                    <Default-Button-Outlined id="AutoTest_MP14" class="btn-122x36" title="Cancel" @click.native="UnarchiveDailog=false"></Default-Button-Outlined>
                                                                </v-col>
                                                            </v-row>
                                                        </v-container>
                                                    </v-col>
                                ...
                                <v-dialog v-model="RemoveProjectDailog" width="800">
                                    <v-card>
                                        <v-card-title primary-title class="page-head py-4">
                                            ...
                                            Remove Project
                                            <v-spacer></v-spacer>
                                            <v-btn id="AutoTest_MP15" text="" @click="RemoveProjectDailog=false">
                                                <v-icon color="#707070" size="15">mdi-close</v-icon>
                                            </v-btn>
                                        </v-card-title>
                                        <v-card-text class="pt-0">
                                                    ...
                                                    <v-col cols="12" md="12" class="pt-0">
                                                        <v-container fluid class="pt-0">
                                                            <v-row>
                                                                ...
                                                                <v-col>
                                                                    <h4 class="text-center heading-3">
                                                                        <v-avatar size="40" color="#fff" class="elevation-1 mr-2">
                                                                            <v-icon class="tmr-2" color="#707070" size="25">mdi-file-document-box-outline</v-icon>
                                                                        </v-avatar>
                                                                        {{ProjectName}}
                                                                    </h4>
                                                                ...
                                                                <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                                    <Secondary-Button id="AutoTest_MP16" class="btn-122x36 mr-4" title="Remove" @click.native="DeleteProject(2)"></Secondary-Button>
                                                                    <Default-Button-Outlined id="AutoTest_MP17" class="btn-122x36" title="Cancel" @click.native="RemoveProjectDailog=false"></Default-Button-Outlined>
                                                                </v-col>
                                                            </v-row>
                                                        </v-container>
                                                    </v-col>
            ...
            <v-dialog v-model="IsActiveToggleDialog" width="800">
                <v-card class="elevation-0">
                    <v-card-title primary-title class="page-head py-4">
                        ...
                        Change State
                        <v-spacer></v-spacer>
                        <v-btn id="AutoTest_MP19" text @click="IsActiveToggleDialog=false">
                            <v-icon color="#707070" size="15">mdi-close</v-icon>
                        </v-btn>
                    </v-card-title>
                    <v-card-text class="pt-0">
                                ...
                                <v-col cols="12" md="12" class="pt-0">
                                    <v-container fluid class="pt-0">
                                        <v-row>
                                            ...
                                            <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                <v-btn id="AutoTest_MP20" color="secondary elevation-0" class="mr-2" @click="ChangeState()">Change</v-btn>
                                                <v-btn id="AutoTest_MP21" outlined color="grey" @click="IsActiveToggleDialog=false, GetProjectListByInitID()">Cancel</v-btn>
                                            </v-col>
            ...
            <v-dialog v-model="dlgSetasTemplate" width="800" persistent>
                <v-card>
                    <v-card-title primary-title="" class="page-head pb-0">
                        ...
                        Save as Template
                        <v-spacer></v-spacer>
                        <v-btn id="AutoTest_MP22" text="" @click="dlgSetasTemplate = false">
                            <v-icon color="#707070" size="15">mdi-close</v-icon>
                        </v-btn>
                    </v-card-title>
                    <v-card-text>
                    ...
                    <v-card-actions class="pb-4">
                        <v-col>
                            <Outlined-Button-Dark id="AutoTest_MP23" class="btn-122x36 float-right" title="Cancel" @click.native="dlgSetasTemplate=false"></Outlined-Button-Dark>
                            <Primary-Button-Light id="AutoTest_MP24" class="btn-122x36 float-right mr-4" title="Confirm" @click.native="dlgSetasTemplate=false,InsertProjectTemplate() " v-show="AddProjectTempSteps==2"></Primary-Button-Light>
                            <v-btn id="AutoTest_MP25" outlined color="grey" class="btn-122x36 float-right" @click="AddProjectTempSteps=1" v-show="AddProjectTempSteps==2">Previous</v-btn>
                            <Primary-Button-Light id="AutoTest_MP26" class="btn-122x36 float-right mr-4" title="Next" @click.native="AddProjectTempSteps=2" v-show="AddProjectTempSteps==1" v-bind:disabled="Template.length == 0 || Template.trim() == ''"></Primary-Button-Light>
                        </v-col>
                    </v-card-actions>
                </v-card>
            </v-dialog>
        ...
        methods: {
            ...
            async ChangeProjectStatus() {
                ...
                if (result.status == "Unhandled Exception") {
                    ...
                    if (result.status = "Success") {
                        this.Msg = ("Successfully Unarchived");
                        this.successSnackbarMsg = true;
                    } else {
