<template>
    <v-container fluid>
        <v-row>
            <v-col cols="auto" class="pt-0 mb-0">
                <h5 class="page-head" v-if="$route.name == 'ManageProjectFinance' || $route.name == 'MyprojectsDraftIndividualFinanceDetails'">
                    <v-avatar color="white" size="25" class="elevation-1 mr-2">
                        <v-icon size="15" color="primary">mdi-cash-multiple</v-icon>
                    </v-avatar><span link @click="">Inputs</span>
                </h5>
            </v-col>
