        ...
        <v-row>
            ...
            <v-row>
              <v-col sm="7" cols="12" class="pl-8">
                <span style="font-size: 13px; font-weight: bold"
                  >Increase in the overall annual income of farmers</span
                >
              </v-col>
              <v-col sm="5" cols="12" class="pt-3">
                <v-row>
                  <v-col sm="12" cols="12" class="pt-0 px-0">
                    <v-chip color="#4CAF50" label dark small> Outputs </v-chip>
          ...
          <v-col sm="12" cols="12" class="pt-0">
            ...
            <v-row>
              <v-col sm="12" cols="12">
                <Line-Chart
                  :linedata="responsesLineData"
                  :lineOptions="responsesLineOptions"
                        ...
                        <v-row>
                          ...
                          <v-col cols="12" sm="12" class="pt-0">
                            <span style="color: #585858"
                              >Type of agricultural produce/crop
                              cultivated</span
                            >
                          </v-col>
                        </v-row>
                ...
                <v-tab-item value="tabs-2">
                  ...
                  >
                    <v-container>
                      ...
                      <v-row>
                        <v-col class="pl-10 pt-6" sm="12" cols="12">
                          <span style="font-size: 16px"
                            >Prediction / Forecasting</span
                          >
                        </v-col>
                      </v-row>
                      <template v-for="(item, index) in data_prediction_list">
                        <v-row :key="index" class="mb-3">
                          ...
                          <v-col cols="12" sm="10" class="pb-0 pt-1 pl-10">
                            <span style="color: #585858" v-html="item.name"></span
                            >
                          </v-col>
                        </v-row>
                      </template>
  ...
  data() {
    return {
      ...
      data_prediction_list: [
        {
          name: `Given the data till date , a <span style="color:red;">positive change of 12% </span> has beem acheived`,
          image: require("@/assets/Outputs/Forecasting_Red.svg"),
        },
        {
          name: `Given the data till date , a <span style="color:red;">positive change of 12% </span> has beem acheived`,
          image: require("@/assets/Outputs/Prediction_Red.svg"),
        },
        {
          name: `Given the data till date , a <span style="color:red;">positive change of 12% </span> has beem acheived`,
          image: require("@/assets/Outputs/Prediction_Red.svg"),
