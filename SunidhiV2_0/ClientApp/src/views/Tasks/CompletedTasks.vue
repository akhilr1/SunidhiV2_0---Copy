<template>
  <!--<v-col cols="12" xs="12" sm="12" md="12">-->
    <v-card class="elevation-0">
                    ...
                    <v-row no-gutters>
                        ...
                        <v-col md="auto" xs="6">
                            ...
                            <v-text-field label="Enter" class="mr-4"
                                          dense="" prepend-inner-icon="mdi-magnify" v-model="vmSearchResponse" @change="GetCompletedTaskData()"
                        ...
                        <v-col md="auto" cols="auto">
                            ...
                            <v-menu :close-on-content-click="false" offset-y="" transition="scroll-y-transition">
                                <template v-slot:activator="{ on }">
                                    <v-btn v-on="on" max-width="29" min-width="40" height="39" outlined="" dense="" class="outlined-btn-dark d-none d-md-inline" @click="resetFilter(),GetCompletedTaskData()">
                        ...
                        <v-menu :close-on-content-click="false" offset-y transition="scroll-y-transition" v-model="dateRangeMenu">
                            ...
                            <v-list color="white" light="" width="auto" max-width="900" min-width="50" class="action-button-list pa-2">
                                ...
                                <v-row justify="center" class="px-2">
                                    <v-col cols="2">
                                        <v-btn height="32" block="" class="elevation-0 " @click="GetCompletedTaskData(),dateRangeMenu = false">
                                            cancel<!--fnClickDateRangeCancel('Date Range'), -->
                                        </v-btn>
                                    </v-col>
                                    <v-spacer></v-spacer>
                                    <v-col cols="2">
                                        <v-btn height="32" block="" color="primary" class="elevation-0" @click="fnFilterDone(), GetCompletedTaskData(), dateRangeMenu = false">
                                            Done
                                        </v-btn>
                                    </v-col>
                                </v-row>
                        ...
                        <v-menu :close-on-content-click="false" offset-y transition="scroll-y-transition" v-model="taskMenu">
                            ...
                            <v-list color="white" light="" width="155" class="action-button-list pa-2">
                                ...
                                <div class="d-inline-flex">
                                    ...
                                    <v-btn id="" height="32" width="32" block color="primary" class="elevation-0" @click="fnFilterDone(),GetCompletedTaskData(), taskMenu = false">
                                        Done
                                    </v-btn>
                                </div>
                            </v-list>
                        ...
                        <v-menu :close-on-content-click="false" offset-y transition="scroll-y-transition" v-model="projectMenu">
                            ...
                            <v-list color="white" light="" width="155" class="action-button-list pa-2">
                                ...
                                <div class="d-inline-flex">
                                    ...
                                    <v-btn id="" height="32" width="32" block color="primary" class="elevation-0" @click="fnFilterDone(),GetCompletedTaskData(),projectMenu = false">
                                        Done
                                    </v-btn>
                                </div>
                            </v-list>
                        ...
                        <v-menu :close-on-content-click="false" offset-y transition="scroll-y-transition" v-model="beneficiaryTypeMenu">
                            ...
                            <v-list color="white" light="" width="auto" class="action-button-list pa-2">
                                ...
                                <div class="d-inline-flex">
                                    ...
                                    <v-btn id="" height="32" width="32" block color="primary" class="elevation-0" @click="fnFilterDone(),GetCompletedTaskData(), beneficiaryTypeMenu = false">
                                        Done
                                    </v-btn>
                                </div>
                            </v-list>
                        ...
                        <v-menu :close-on-content-click="false" offset-y transition="scroll-y-transition" v-model="workflowMenu">
                            ...
                            <v-list color="white" light="" width="auto" max-width="250" min-width="50" class="action-button-list pa-2">
                                ...
                                <div class="d-inline-flex">
                                    ...
                                    <v-btn id="" height="32" width="32" block color="primary" class="elevation-0" @click="fnFilterDone(),GetCompletedTaskData(), workflowMenu = false,SaveSelectedFilter(SelectedFilter)">
                                        Done
                                    </v-btn>
                                </div>
                            </v-list>
                ...
                <div class="chip-container ma-0">
                    <v-chip-group multiple column active-class="primary--text">
                        <v-chip id="" v-for="(item,key) in filterChipsList" v-bind:key="item.ChipID" class="mx-2" medium label>
                            <v-icon small left @click="fnChipClose(item), GetCompletedTaskData()">mdi-close</v-icon>{{ item.ChipName }}
                        </v-chip>
                    </v-chip-group>
                </div>
            </v-col>
                                ...
                                <v-menu :close-on-content-click="false" offset-y transition="scroll-y-transition" v-model="dateRangeMenu">
                                    ...
                                    <v-list color="white" light="" width="auto" max-width="900" min-width="50" class="action-button-list pt-10" style="height:50vh">
                                        ...
                                        <v-row justify="center" class="px-2">
                                            ...
                                            <v-spacer></v-spacer>
                                            <v-col cols="4">
                                                <v-btn height="32" x-large block="" color="primary" class="elevation-0" @click="fnFilterDone(), GetCompletedTaskData(), dateRangeMenu = false">
                                                    Done
                                                </v-btn>
                                            </v-col>
                                        </v-row>
                                ...
                                <v-menu :close-on-content-click="false" offset-y transition="scroll-y-transition" v-model="workflowMenu">
                                    ...
                                    <v-list color="white" light="" width="auto" max-width="250" min-width="50" class="action-button-list pa-2">
                                        ...
                                        <div class="d-inline-flex">
                                            ...
                                            <v-btn id="" height="32" width="32" block color="primary" class="elevation-0" @click="fnFilterDone(),GetCompletedTaskData(), workflowMenu = false">
                                                Done
                                            </v-btn>
                                        </div>
                                    </v-list>
                            ...
                            <v-row v-if="filterChipsList.length>0" justify="center" no-gutters class="pa-0 my-0">
                                <v-col md="10" class="d-flex">
                                    <div class="mobile-chip-container ma-0 ">
                                        <v-chip-group multiple column active-class="primary--text">
                                            <v-chip id="" close v-for="(item,key) in filterChipsList" v-bind:key="item.ChipID" class="mx-2" @click:close="fnChipClose(item), GetCompletedTaskData()" small label>
                                                {{ item.ChipName }}
                                            </v-chip>
                                        </v-chip-group>
                                    </div>
                ...
                <v-row no-gutters>
                    ...
                    <v-col cols="12" md="4" align="center">
                        <p class="black--text">
                            ...
                            <!--<span v-if="syncLabel==2">Pending Sync Items({{this.SetCunt}})</span>
        ...
        <!--all completed card-->
        <v-row justify="center" v-if="MyTask.length > 0">
            <v-col md="10" class="v-scrolling-div  py-0 my-0 mb-0 overdueCardHeight">
                <div v-for="item in MyTask" :key="item.TaskId" class="pa-0 ma-0">
                    ...
                    <v-card :class="{'task-issue-card' :item.TaskType=='Issue',
                            ...
                            }" class="mb-2 mb-md-4" @click.native="">
                        ...
                        <v-card-text class="d-none d-sm-block py-0 mb-1">
                            <p class="font-weight-regular heading-3 text-truncate py-0 my-0" style="height:auto;max-height:100px;overflow-y:auto">
                                {{item.Description}}
                            </p>
                        </v-card-text>
                        <v-card-subtitle class="px-4 py-0 pb-3">
...
<script>
    ...
    var objProject;
    async function importscriptmyproject() {
        return Promise.all([
    ...
    export default {
        ...
        methods: {
            ...
            async GetCompletedTaskData() {
                ...
                this.MyTask = [],
                    this.lstActivity=[],
                    this.lstTask = await dbImworks.TbMyTask.toArray();
                var filterTaskArray = this.filterTask(this.lstTask);

                filterTaskArray.sort((a, b) => b.pkId - a.pkId); // reverse order;
                
                if (this.vmSearchResponse != "") {
                    var myTaskList = filterTaskArray.filter(x => ((x.Type.toLowerCase().includes(this.vmSearchResponse.toLowerCase())) || (x.TaskName.toLowerCase().includes(this.vmSearchResponse.toLowerCase()))));
                }
                else if (this.vmSearchResponse == "") {
                    var myTaskList = filterTaskArray;
                }
                for (var i = 0; i < filterTaskArray.length; i++) {
                    if (filterTaskArray[i].WFLevelStatus == 'Completed' ) {                       
                        this.MyTask.push({
                            ActivityId: 0,
                            TaskName: myTaskList[i].TaskName, TaskType: myTaskList[i].Type, CreatedDate:  myTaskList[i].CreatedDate,
                            Description: myTaskList[i].Description, ProjectName: myTaskList[i].ProjectName, TaskDate: myTaskList[i].TaskDate
                        });
                    }
            ...
            fnFilterDone() {
                ...
                for (var i = 0; i < this.selectedBeneficiaryTypeID.length; i++) {
                    if (this.selectedBeneficiaryTypeID[i]) {
                        ...
                        this.selectedbeneficiary.push(this.lstBType[i].BeneficiaryTypeID);
            ...
            filterTask(lstTask) {
                ...
                if (this.filtervalue.length > 0) {
                    ...
                    filterTaskArray = [];
                    var seperateFilter = this.filtervalue.split(',');
                ...
                if (this.projectname.length > 0) {
                    ...
                    for (var i = 0; i < this.projectname.length; i++) {
                        var temp = filterTaskArrayTemp1.filter(x => x.ProjectName == this.projectname[i]);
                        for (var j = 0; j <= temp.length - 1; j++) {
                            filterTaskArray.push(temp[j]);
                        }
                    }
                    //filterTaskArray = filterTaskArray.filter(x => x.ProjectName == this.projectname);
                }
                ...
                if (this.beneficiaryname.length > 0) {
                    ...
                    filterTaskArray = [];
                    for (var i = 0; i < this.beneficiaryname.length; i++) {
                        var temp = filterTaskArrayTemp2.filter(x => x.BeneficiaryTypeID == this.beneficiaryname[i]);
                        for (var j = 0; j <= temp.length - 1; j++) {
                            filterTaskArray.push(temp[j]);
                        }
                    }
