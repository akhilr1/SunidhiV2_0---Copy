<template>
    ...
    <v-card class="elevation-0">
            ...
            <v-col md="10" class="my-0 py-0">
                <v-card-title class="px-1 py-1 my-0">
                    <v-row no-gutters="">
                        ...
                        <v-col md="auto" xs="6">
                            <!--Search-->
                            <v-text-field label="Enter" class="mr-4" v-model="vmSearchResponse" @change="GetCompletedTaskData()"
                                ...
                                <v-menu :close-on-content-click="false" offset-y transition="scroll-y-transition" v-model="dateRangeMenu">
                                    ...
                                    <v-list color="white" light="" width="auto" max-width="900" min-width="50" class="action-button-list pt-10" style="height:50vh">
                                        ...
                                        <v-row justify="center" class="px-2">
                                            ...
                                            <v-spacer></v-spacer>
                                            <v-col cols="4">
                                                <v-btn height="32" x-large block="" color="primary" class="elevation-0" @click="dateRangeMenu = false">
                                                    Done
                                                </v-btn>
                                            </v-col>
                                        </v-row>
        ...
        <v-col md="10">
            <v-row no-gutters>
                <v-chip class="mx-2" medium label clearable close>30 jun - 30 jul</v-chip>
                <v-chip class="mx-2" medium label clearable close>Output</v-chip>
                <v-chip class="mx-2" medium label clearable close>Survey</v-chip>
                <v-chip class="mx-2" medium label clearable close>Teach Each</v-chip>
                <v-chip class="mx-2" medium label clearable close>To Approve</v-chip>
            </v-row>
        </v-col>
    </v-row>-->
        <!--sync divider line-->
    ...
    <span v-if="syncLabel==0">All Synced</span>-->
        ...
        <!--all saved card-->
        <v-row justify="center" v-if="lstMyTask.length > 0">
            <v-col md="10" class="v-scrolling-div py-0 my-0 mb-0 overdueCardHeight">
                    ...
                    <v-card-text>
                        <v-row>
                            <v-col>
                                ...
                                <v-file-input class="vFileInput" small-chips label="Upload Attachment" truncate-length="10" v-model="IssuefileInput" prepend-icon="mdi-paperclip" outlined="" dense=""
            ...
            <v-dialog v-model="dlgSurveyType" width="800" transition="dialog-bottom-transition" persistent>
                <v-card class="elevation-0 dialogHeight">
                    ...
                    <v-card-text v-show="IsUpdate_BenSurvey == false && IsInputFinished == false" class="px-3 py-1">
                        ...
                        <v-row class="py-0 my-2">
                            <v-col cols="12" xs="12" sm="12" md="12" class="text-center text-md-right py-0 my-0">
                                <Secondary-Button class="btn-122x36 mr-4" title="Update" @click.native="IsUpdate_BenSurvey = true" v-bind:disabled="this.lstSurveyQstns.length==0"></Secondary-Button>
                    ...
                    <v-card-text v-show="IsUpdate_BenSurvey == true && IsInputFinished == false" class="px-3 py-1">
                        <v-stepper v-model="BenefLinkedSurveySteps" class="elevation-0">
                            <v-stepper-items>
                                ...
                                <v-stepper-content step="1" class="pa-0">
                                    ...
                                    <v-row class="py-0 my-2">
                                        <v-col cols="12" xs="12" sm="12" md="12" class="text-center text-md-right py-0 my-0">
                                            <Secondary-Button class="btn-122x36 mr-4" title="Next" @click.native="GetBeneficiary()" v-bind:disabled="vmAddBeneficiaryChoice==0"></Secondary-Button>
                                ...
                                <v-stepper-content step="2" class="pa-0">
                                    ...
                                    <v-row class="py-0 my-2">
                                        <v-col cols="12" xs="12" sm="12" md="12" class="text-center text-md-right py-0 my-0">
                                            <Secondary-Button class="btn-122x36 mr-4" title="Next" @click.native="GetSelectedBeneficiaries()" v-bind:disabled="!CheckMandatory()"></Secondary-Button>
                                ...
                                <v-stepper-content step="3" class="pa-0">
                                    ...
                                    <v-row class="py-0 my-2">
                                        <v-col cols="12" xs="12" sm="12" md="12" class="text-center text-md-right py-0 my-0">
                                            <Secondary-Button class="btn-122x36 mr-4" title="Next" @click.native="GetBenefRegistrationQstns()"></Secondary-Button>
                                            <Default-Button-Outlined class="btn-122x36" title="Previous" @click.native="BenefLinkedSurveySteps = 1"></Default-Button-Outlined>
                                        </v-col>
                                    </v-row>
                                ...
                                <v-stepper-content step="4" class="pa-0">
                                    ...
                                    <v-row class="py-0 my-2">
                                        <v-col cols="12" xs="12" sm="12" md="12" class="text-center text-md-right py-0 my-0">
                                            <Secondary-Button class="btn-122x36 mr-4" title="Next" @click.native="GetBenefSurveyUpdateChoice()" v-bind:disabled="vmBenefSurveyChoice==0"></Secondary-Button>
                                            <Default-Button-Outlined class="btn-122x36" title="Previous" @click.native="BenefLinkedSurveySteps = 1"></Default-Button-Outlined>
                                        </v-col>
                                    </v-row>
                                </v-stepper-content>
...
onFocusCheckQstnValidation(item)" @change="onFocusCheckQstnValidation(item),AddSectionLogic(item.QuestionID,BenefStepper)">
                ...
                <source :src=savedAudio type="audio/mp3">
                                                    ...
                                                    <div v-if="RepeatSection.length >0 && Ritem.ParentQuestionID == item.QuestionID && BenefStepper == Ritem.benefIndex" v-for="(Ritem,RIndex) in RepeatSection" :key="RIndex" class="mb-4">
                                                        ...
                                                        <div class="mb-6" v-if="Ritem.QuestionType==='GPS Capture'" v-model="Ritem.Answer">
                                                            ...
                                                            <GmapMap :center="Coordinates"
                                                                     :zoom="13"
                                                                     style="width: 100%; height: 100px" @click.native="GetGPSCoordinatesRepeat(Ritem.QuestionID,false, Ritem.RQstInd)">
                                                                <GmapMarker :position="Coordinates"
                                                                            :clickable="true"
                                ...
                                <v-stepper-content step="6" class="pa-0">
                                    ...
                                    <v-row class="py-0 my-2">
                                        <v-col cols="12" xs="12" sm="12" md="12" class="text-center text-md-right py-0 my-0">
                                            <Secondary-Button class="btn-122x36 mr-4" title="Next" @click.native="SubmitBenefSurvey()" v-bind:disabled="vmBenefSurveySubmitOption==0"></Secondary-Button>
                                                    ...
                                                    <v-stepper-content step="1" class="px-3 py-0">
                                                        <v-container fluid="" class="pa-0">
                                                            ...
                                                            <v-row class="my-2 py-0">
                                                                <v-col cols="12" xs="12" sm="12" md="12" class="text-center text-md-right py-0 my-0">
                                                                    <Secondary-Button class="btn-122x36 mr-2" title="Next" @click.native="ImportBeneficiaryTaskSteps=3"></Secondary-Button>
                                                    ...
                                                    <v-stepper-content step="3" class="pa-0">
                                                        <v-container fluid="" class="pt-0">
                                                            <v-row no-gutters="">
                                                                ...
                                                                <v-col cols="12" md="12" class="pt-0 mb-2 text-center">
                                                                    <p class="text-medium">
                                                                        Your Task has been updated successfully.<br />Bask in your glory !
                                                                    </p>
                                                                </v-col>
                                                                <v-col cols="12" md="12" class="pt-0 text-center">
                                                                    <v-btn color="secondary" class="mr-2 elevation-0" @click="ImportSurvey()">Done</v-btn>
                                                                </v-col>
                                                            </v-row>
                                                        </v-container>
                                                    </v-stepper-content>
                                            ...
                                            <v-stepper-content step="2" class="pt-0">
                                                <v-container fluid="" class="pt-0">
                                                    <v-row no-gutters="">
                                                        ...
                                                        <v-col cols="12" md="12" class="pt-0 mb-2 text-center">
                                                            <p class="text-medium">
                                                                Your Beneficiary has been created successfully.<br />Bask in your glory !
                                                            </p>
                                                        </v-col>
                                                        <v-col cols="12" md="12" class="pt-0 mb-2 text-center">
                    ...
                    <v-card-text v-show="IsInputFinished == true" class="px-3 py-1">
                        <div class="taskHeight">
                            ...
                            <v-row>
                                ...
                                <v-col>
                                    ...
                                    <v-file-input class="vFileInput" small-chips truncate-length="10" label="Upload Attachment" v-model="fileInput" prepend-inner-icon="mdi-paperclip" prepend-icon="" outlined="" dense=""
                                                  id="file" accept="*"></v-file-input>
                                </v-col>
                            </v-row>
                        </div>
                        <v-row class="py-0 my-2">
                            <v-col cols="12" xs="12" sm="12" md="12" class="text-center text-md-right py-0 my-0">
                                <Secondary-Button class="btn-122x36 mr-2" title="Update" @click.native="UpdateTask(),ClearBenefSurveyUpdate()"></Secondary-Button>
            ...
            <v-dialog v-model="dlgNonBeneficarySurveyType" width="800" persistent transition="dialog-bottom-transition">
                <v-card class="elevation-0 dialogHeight">
                    <v-row class="mx-4 pt-6" no-gutters>
                        <v-col cols="auto" class="limited-width-CardTitle text-truncate page-head">
                            <v-btn class="d-sm-none" text small @click="ClearBenefSurveyUpdate()">
                    ...
                    <v-card-text v-show="IsUpdate_BenSurvey == false && IsInputFinished == false" class="px-3 py-1">
                                                            ...
                                                            <v-list-item-content>
                                                                <v-list-item-title class="pb-0 pt-0">
                                                                    <v-row class="d-lg-inline-flex pb-0">
                                                                        ...
                                                                        <v-col>
                                                                            <h4 class="font-weight-regular heading-3"> {{new Date(item.CreatedDate).toLocaleDateString('en-GB')}}</h4>
                        ...
                        <v-row class="py-0 my-2">
                            <v-col cols="12" xs="12" sm="12" md="12" class="text-center text-md-right py-0 my-0">
                                <Secondary-Button class="btn-122x36 mr-4" title="Update" @click.native="IsUpdate_BenSurvey = true,GetBenefSurveyQstns()"></Secondary-Button>
                                <Default-Button-Outlined class="btn-122x36" title="Cancel" @click.native="ClearBenefSurveyUpdate()"></Default-Button-Outlined>
                            </v-col>
                        </v-row>
                    </v-card-text>
        ...
        @focus="onFocusCheckQstnValidation(item)"/>  onKeyPress="if (this.qType == 'number') if(this.value.length==10) return false;"
            onKeyPress="if (this.QstType ='PhoneNumber' && this.value.length==10) return false;"-->
                                                ...
                                                <v-layout row>
                                                    <v-flex grow>
                                                        <v-text-field v-if="item.QuestionType==='Numeric'" full-width outlined dense type="number" label="Type your answer" v-model="item.Answer"
                                                                      ...
                                                                      onKeyPress="if(this.value.length==10) return false;" :readonly="item.IsFormulaQuestion == true"
                                                                      :value="item.DefaultValue" :min="minVal" :max="maxVal"
                                                                      @focus="Calculate(item.QuestionID,BenefStepper)" @change="AddSectionLogic(item.QuestionID,BenefStepper)">
                                                        </v-text-field>
                                                    </v-flex>
                                                    <v-flex shrink>
                                                        <!--<v-text-field  class="mr-2 ml-2" v-if="item.QuestionType==='Numeric'" :placeholder="item.UOM" outlined="" dense="" disabled=""></v-text-field>-->
                                        ...
                                        <div v-if="item.QuestionType==='Single Choice'" class="mt-0">
                                            ...
                                            <v-radio-group class="py-0 my-0" v-model="item.Answer" @change="AddSectionLogic(item.QuestionID,BenefStepper)">
                                                <v-radio color="success" hide-details v-for="(optItem,ind) in item.QuestionOptions" :key="ind"
                                                         :label="optItem.OptionValue"
                                                         :value="optItem.OptionValue"></v-radio>
                                            </v-radio-group>
                                        ...
                                        <div class="mb-6" v-if="item.QuestionType==='Date Picker'">
                                            <v-menu v-model="mDate"
                                                    ...
                                                    min-width="290px">
                                                <template v-slot:activator="{ on }">
                                                    <v-text-field v-model="computedDate"
                                                                  prepend-inner-icon="mdi-calendar"
                                                                  outlined
                                                                  readonly
                                                                  dense
                                                                  @click:prepend-inner="mDate = true"
                                                                  v-on="on" hide-details></v-text-field>
                                                </template>
                                                <v-date-picker v-model="vmDate" no-title @input="item.Answer=vmDate,mDate = false" format="DD-MM-YYYY"></v-date-picker>
                                            </v-menu>
                                        </div>
                                        ...
                                        <div class="mb-6" v-if="item.QuestionType==='GPS Capture'" v-model="item.Answer">
                                            ...
                                            <GmapMap :center="Coordinates"
                                                     :zoom="13"
                                                     style="width: 100%; height: 100px" @click.native="GetGPSCoordinates(item.QuestionID,false)">
                                                <GmapMarker :position="Coordinates"
                                                            :clickable="true"
                                                            :draggable="true" />
                                            </GmapMap>
                                        ...
                                        <div class="mb-6" v-if="item.QuestionType==='Photo Capture'">
                                            ...
                                            <v-radio-group row v-model="audUpload[QIndex]" @change="item.IsUpload=audUpload[QIndex]">
                                                <v-radio color="success" class="py-0 my-0" label="Photo Capture" hide-details>
                                                </v-radio>
                                                <v-radio color="success" label="Photo Upload" hide-details>
                                                </v-radio>
                                            </v-radio-group>
                                        ...
                                        <!--Audio Capture-->
                                        <div class="mb-6" v-if="item.QuestionType==='Audio Capture'">
                                            <v-radio-group class="py-0 my-0" row v-model="audUpload[QIndex]" @change="item.IsUpload=audUpload[QIndex]">
                                                <v-radio color="success" label="Audio Capture" hide-details>
                                                </v-radio>
                                                <v-radio color="success" label="Audio Upload" hide-details>
                                            ...
                                            <v-row class="py-0 my-0">
                                                <v-col class="py-0 my-0">
                                                    <v-select dense :menu-props="{ maxHeight: '300' }" filled v-model="optItem[ind]"
                                                              ...
                                                              :items="optItem.CascadingList"
                                                              item-text="Name"
                                                              item-value="ID" @change="FilterSubItem(item,optItem,optItem[ind],false,0,false)">
                                                    </v-select>
                        ...
                        <v-row class="py-0 my-2">
                            <v-col md="12" class="text-center text-md-right py-0 my-0">
                                <Secondary-Button class="btn-122x36 mr-4" title="Next" @click.native="UpdateBenefLinkedSectionQstnAnswers(BenefStepper),scrollToTop(lstSectionQstns)"></Secondary-Button>
                                <Default-Button-Outlined class="btn-122x36" title="Previous" @click.native="PreviousBenefSectionQstnAnswers(),scrollToTop()"></Default-Button-Outlined>
                            </v-col>
                        </v-row>
                    </v-card-text>
                    ...
                    <v-card-text v-show="IsInputFinished == true " class="px-3 py-1">
                        <div class="taskHeight py-0 my-0">
                            ...
                            <v-row>
                                <v-col>
                                    ...
                                    <v-file-input class="vFileInput" small-chips label="Upload Attachment" truncate-length="10" v-model="fileInput" prepend-icon="mdi-paperclip" outlined="" dense=""
                                                  id="file" accept="*"></v-file-input>
                                </v-col>
                            </v-row>
                        </div>
                        <v-row class="py-0 my-2">
                            <v-col cols="12" xs="12" sm="12" md="12" class="text-center text-md-right py-0 my-0">
                                <Secondary-Button class="btn-122x36 mr-4" title="Update" @click.native="UpdateTask(),ClearBenefSurveyUpdate()"></Secondary-Button>
        ...
        <v-row v-else justify="center">
            <v-col class="text-center overdueCardHeight">
                <p style="margin-top:8%">
                    <img src="..\..\..\src\assets\EmptyPlaceholders\task.svg" height="150" width="150" />
                </p>
                <p class="heading-4-dark font-weight-medium pt-0">No task available</p>
            </v-col>
        </v-row>
    ...
    export default {
        ...
        methods: {
            ...
            async GetMyTaskList() {     
                ...
                var props = ['SyncDBID', 'Command', 'Type', 'TypeID', 'TypeIDColumn', 'Status', 'WorkflowID', 'TotalWFLevel', 'WFLevel', 'WFLevelStatus', 'ResponseSyncID', 'DataCollectedBy', 'TaskDate', 'TaskSubmittedDate', 'TaskData', 'WorkspaceID'];
                var myList = this.lstTaskList.filter(function (o1) {
                    // filter out (!) items in result2
                    return lstSavedList_Var.some(function (o2) {
                        return o1.SyncDBID === o2.SyncDBID && o1.TaskDate === o2.TaskDate;          // assumes unique id
                    });
                }).map(function (o) {
                ...
                this.GetMyList(myList);

            },

            async GetMyList(myList) {
                ...
                for (var i = 0; i < myList.length; i++) {
                    ...
                    if (myList[i].Type == 'Survey') {
                        ...
                        if (objSurvey != null) {
                            ...
                            if (this.vmSearchResponse != '') {
                                var mySurveyDataList = this.lstSurvey.filter(x => ((x.SurveyName.toLowerCase().includes(this.vmSearchResponse.toLowerCase()))));
                                if (myList[i].Type.toLowerCase().includes(this.vmSearchResponse.toLowerCase())) {
                                    McuntAct = 1;
                                };
                            ...
                            else if (this.vmSearchResponse == '') {
                                McuntAct = 1;
                            }

                            if (McuntAct == 1) {
                                var myActivityList = objSurvey;
                                this.lstAllMyTask.push({
                                    TaskType: 'Survey', TypeColor: 'rgba(33,150,243,.2)', TaskTypeID: myActivityList.SurveyID, TaskName: myActivityList.SurveyName, TaskDate: myList[i].TaskDate,
                                    TaskDescription: myActivityList.Description, ProjectName: myActivityList.ProjectName, SurveyList: myActivityList.SurveyQstnList,
                                    BeneficiaryTypeList: myActivityList.BeneficiaryTypeList, BeneficiaryRegistrationQstns: myActivityList.BeneficiaryRegistrationQstns,
                                    ProjectId: myActivityList.ProjectId, CreatedDate: myActivityList.CreatedDate, Periodicity: myActivityList.Periodicity, vMenu: false,
                                    TypeIDColumn: myList[i].TypeIDColumn, WorkspaceID: myList[i].WorkspaceID, IsBeneficiaryLinked: myActivityList.BeneficiaryTypeID != null ? true : false
                                });

                                this.varIsBeneficiaryLinked = myActivityList.BeneficiaryTypeID != null ? true : false;

                                this.ProjectID = myActivityList.ProjectId;
                            }
                ...
                this.lstMyTask = this.lstAllMyTask;
            ...
            async GetTaskDetails(Item) {
                ...
                if (Item.TaskType == 'Survey') {
                    ...
                    if (!Item.IsBeneficiaryLinked)    // (this.lstSelectedTask.BeneficiaryList == null )
                    ...
                    if (QItem != null) {
                        for (var i = 0; i < QItem.CascadingQuestionOptions.length; i++) {
                            if (QItem.CascadingQuestionOptions[i].OptionValue == "Country") {
                                this.lstCountry = lstCascadingItems[0].Country;
                                ...
                                this.lstStates = lstCascadingItems[0].States;
                                ...
                                this.lstDistrict = lstCascadingItems[0].District;
                                ...
                                this.lstSubDistrict = lstCascadingItems[0].SubDistrict;
                    ...
                    for (var i = 0; i <= currSecQstns.length - 1; i++) {
                        ...
                        if (benefSurveyQstn.length > 0) {
                            ...
                            if ((currSecQstns[i].QuestionType == "Photo Capture") || (currSecQstns[i].QuestionType == "Signature Capture") ||
                                ...
                                // To Read Photo
                                if (currSecQstns[i].QuestionType == "Photo Capture") {
                                ...
                                if (currSecQstns[i].QuestionType == "Signature Capture") {
                                    var UploadIndex = benefSurveyQstn.filter(x => x.QuestionID == currSecQstns[i].QuestionID)[0].IsUpload;
                                    this.lstSectionQstns[i].IsUpload = UploadIndex;
                                    this.audUpload[i] = UploadIndex;
                                ...
                                if (currSecQstns[i].QuestionType == "Audio Capture") {
                        ...
                        if (lstDefaultAnsQuestions.length > 0) {
                            ...
                            if (lstConditionQuestion.length > 0) {
                                for (var Cnt = 0; Cnt <= lstConditionQuestion.length - 1; Cnt++) {
                                    var IsExistInSkipLogic = this.RepeatSection.filter(x => x.ParentQuestionID == lstConditionQuestion[Cnt].QuestionID);
            ...
            UpdateBenefLinkedSectionQstnAnswers(benefIndx) {
                ...
                for (var i = 0; i < this.RepeatSection.length; i++) {

                    Ans = "";
                    if (this.RepeatSection[i].QuestionID > 0) {
                        //if (this.CheckQstnValidation(this.lstSectionQstns[i]))
                        // if(this.fnCheckQuestionValidationAndCondition(this.lstSectionQstns,benefID))
                        // {
                        //    count++;
                        ...
                        if (this.RepeatSection[i].QuestionType == 'Multi-Choice') {
                            var ChoiceAns = this.MultiChoiceAnsForRepeat.filter(x => x.QuestionID == this.RepeatSection[i].QuestionID && x.RQstInd == this.RepeatSection[i].RQstInd);
                            for (var j = 0; j < ChoiceAns.length; j++) {
                                Ans = (Ans != '') ? Ans + ',' + ChoiceAns[j].OptionValue : ChoiceAns[j].OptionValue;
                            }
                        }
                        else if (this.RepeatSection[i].QuestionType == "Cascading Dropdown") {
                            this.cascadingAns = this.cascadingAnsArray.filter(x => (x.QID == this.RepeatSection[i].QuestionID) && (x.IsBenefQstn == false) && (x.BenefID == benefID));

                            for (var j = 0; j < this.cascadingAns.length; j++)
                                Ans = (Ans != '') ? Ans + ',' + this.cascadingAns[j].Ans : this.cascadingAns[j].Ans;
                        }

                        else if ((this.RepeatSection[i].QuestionType == "Audio Capture") || (this.RepeatSection[i].QuestionType == "Signature Capture")
                            || (this.RepeatSection[i].QuestionType == "Photo Capture") || (this.RepeatSection[i].QuestionType == "File Upload")) {

                            if (this.AnsBlob.length > 0) {
                                blobFile = this.AnsBlob.filter(x => (x.QuestionID == this.RepeatSection[i].QuestionID) && (x.BenefID == benefID) && (x.RQstInd == this.RepeatSection[i].RQstInd))[0];
                                this.FileUpload(blobFile.blobData, this.RepeatSection[i].Answer, false, blobFile.IsUploadedFile, benefID);
                            }
                        ...
                        preAns = this.lstBenefSurveyQstnAnswers.filter(x => (x.BeneficiaryInd == benefIndx) && (x.ResponseID == benefID) &&
                            (x.SectionID == this.RepeatSection[i].SectionID) && (x.QuestionID == this.RepeatSection[i].QuestionID) && (x.RQstInd == this.RepeatSection[i].RQstInd));

                        if (preAns.length == 0) {
                            this.lstBenefSurveyQstnAnswers.push({
                                BeneficiaryInd: benefIndx, ResponseID: benefID, SurveyID: this.RepeatSection[i].SurveyID,
                                SectionID: this.RepeatSection[i].SectionID, QuestionID: this.RepeatSection[i].QuestionID, Answer: Ans,
                                FieldVar: this.RepeatSection[i].FieldVar, RQstInd: this.RepeatSection[i].RQstInd, IsUpload: this.RepeatSection[i].IsUpload
                            });
                        }
                        else {
                            for (var j = 0; j < this.lstBenefSurveyQstnAnswers.length; j++) {
            ...
            async Calculate(QID, benefIndx) {
                ...
                if (typeof this.lstSectionQstns.filter(x => x.QuestionID == QID)[0] != 'undefined') {
                    if (this.lstSectionQstns.filter(x => x.QuestionID == QID)[0].IsFormulaQuestion) {
                        ...
                        if (FormulaQuestion.FormulaOperation == 'RepeatVal_Aggregate') {
                            this.RepeatVal_Aggregate(QID, benefIndx);
                            return false;
                        }
            ...
            RepeatVal_Aggregate(QID, benefIndex) {
                var formulaExp = "";
                var resultVal = 0;
                if (this.RepeatSection.length > 0) {
                    ...
                    if (this.lstSectionQstns.filter(x => x.QuestionID == QID)[0].IsFormulaQuestion) {
                        ...
                        if (FormulaQuestion.FormulaFieldVariables != "") {
                            var arr = FormulaQuestion.FormulaFieldVariables.split(",");
                            if (typeof this.RepeatSection.filter(x => x.FieldVar == arr[0])[0] != "undefined") {
                                var RepeatSection = this.RepeatSection.filter(x => x.FieldVar == arr[0] && x.benefIndex == benefIndex);
                        ...
                        if (SectionLogic != null) {
                            if (SectionLogic[0].LogicType == "Skip Logic") {
                                ...
                                if (IsLogicSatisfied == true) {
                                    ...
                                    var IsExistSkipLogic = this.RepeatSection.filter(x => x.ParentQuestionID === QuestionID);
                                    for (var i = 0; i <= IsExistSkipLogic.length - 1; i++) {
                                        const index = this.RepeatSection.findIndex((element, index) => {
                                            if (element.ParentQuestionID === IsExistSkipLogic[i].ParentQuestionID) {
                                                return true
                                            }
                                        });
                        ...
                        if (SectionLogic != null) {
                            if (SectionLogic[0].LogicType == "Skip Logic") {
                                ...
                                if (IsLogicSatisfied == true) {
                                    ...
                                    var TempExistData = this.RepeatSection.filter(x => x.ParentQuestionID === QuestionID);
                                    if (TempExistData.length > 0) {
                                        for (var i = 0; i <= TempExistData.length - 1; i++) {
                                            const index = this.RepeatSection.findIndex((element, index) => {
                                                if (element.ParentQuestionID === TempExistData[i].ParentQuestionID) {
                                                    return true
                                                }
                                            });
                                            this.RepeatSection.splice(index, 1);
                                    ...
                                    // Finding skip logic section of a question already there in RepeatSection, if yes we need to remove from the array
                                    var TempExistData = this.RepeatSection.filter(x => x.SectionID === skipSectionID);
                                    if (TempExistData.length > 0) {
                                        for (var i = 0; i <= TempExistData.length - 1; i++) {
                                            const index = this.RepeatSection.findIndex((element, index) => {
            ...
            async UpdateTask() {
                ...
                if (this.varIsSubmitted == 0) {
                    ...
                    var a = await dbImworks.SavedTaskDB.where({ SyncDBID: parseInt(task.SyncDBID), TaskDate: TaskDetails.TaskDate }).toArray();
                    if (a.length > 0) {
                        ...
                        for (var i = 0; i <= IsQAnswers.length - 1; i++) {
                            if (IsQAnswers[i].QuestionType != "Cascading Dropdown" && IsQAnswers[i].QuestionType != "Photo Capture" && IsQAnswers[i].QuestionType != "Multi-Choice") {
                                ...
                                if ((CascadingAns == null || CascadingAns.length == 0 || CascadingAns.length < IsQAnswers[i].CascadingQuestionOptions.length)) {
                                    ...
                                    this.RepeatSection.filter(x => x.QuestionID == IsQAnswers[i].QuestionID)[0].ValidationErrorTest = "";
