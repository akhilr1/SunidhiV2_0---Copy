                ...
                <v-row>
                  ...
                  <v-menu offset-y="" transition="scroll-y-transition" v-bind:disabled ="!screenAccess">
                    ...
                    <v-list color="white" light="" width="auto" max-width="250" class="action-button-list">
                      ...
                      <v-list-item id="AutoTest_IP8" @click.stop="fnBulkRemoveClick()">
                        <v-list-item-icon>
                    ...
                    <v-dialog v-model="RemoveBulkProjectDailog" width="800">
                      <v-card>
                        <v-card-title primary-title="" class="page-head py-4">
                          ...
                          Remove Project
                          <v-spacer></v-spacer>
                          <v-btn id="AutoTest_IP9" text="" @click="RemoveBulkProjectDailog=false">
                                ...
                                <v-container fluid="" class="pt-0">
                                  <v-row>
                                    ...
                                    <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                      <Secondary-Button id="AutoTest_IP10" class="btn-122x36 mr-4" title="Remove" @click.native="DeleteProject(1)"></Secondary-Button>
                                      <Default-Button-Outlined id="AutoTest_IP11" class="btn-122x36" title="Cancel" @click.native="RemoveBulkProjectDailog=false"></Default-Button-Outlined>
                                    </v-col>
                                  </v-row>
                                </v-container>
                              </v-col>
                        ...
                        <template v-slot:item.Actions="{item}">
                            <v-menu close-on-content-click offset-y left transition="scroll-y-transition" v-bind:disabled ="!screenAccess">
                                ...
                                <v-list color="white" light width="auto" class="action-button-list">
                                    <v-list-item id="AutoTest_IP12" link="" @click.stop="GetProjectID(item.ProjectId,item.ProjectName),UnarchiveDailog=true,ProjectName=item.ProjectName">
                                        <v-list-item-icon>
                                    ...
                                    <v-list-item id="AutoTest_IP13" link="" @click.stop="GetProjectID(item.ProjectId,item.ProjectName),RemoveProjectDailog=true,ProjectName=item.ProjectName">
                                        <v-list-item-icon>
                                            <v-icon>mdi-trash-can-outline</v-icon>
                                        </v-list-item-icon>
                                        <v-list-item-content>
                                ...
                                <v-dialog v-model="UnarchiveDailog" width="800">
                                    <v-card>
                                        <v-card-title primary-title class="page-head py-4">
                                            ...
                                            Unarchive Project
                                            <v-spacer></v-spacer>
                                            <v-btn id="AutoTest_IP14" text="" @click="UnarchiveDailog=false">
                                                <v-icon color="#707070" size="15">mdi-close</v-icon>
                                            </v-btn>
                                        </v-card-title>
                                        <v-card-text class="pt-0">
                                                            ...
                                                            <v-row>
                                                                ...
                                                                <v-col>
                                                                    <h4 class="text-center heading-3">
                                                                      <v-avatar size="40" class="mr-2 elevation-1" color="#fff">
                                                                ...
                                                                <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                                   <Secondary-Button id="AutoTest_IP15" class="btn-122x36 mr-4" title="Unarchive" @click.native="ChangeProjectStatus()"></Secondary-Button>
                                                                  <Default-Button-Outlined id="AutoTest_IP16" class="btn-122x36" title="Cancel" @click.native="UnarchiveDailog=false"></Default-Button-Outlined>
                                                                </v-col>
                                                            </v-row>
                                                        </v-container>
                                                    </v-col>
                                ...
                                <v-dialog v-model="RemoveProjectDailog" width="800">
                                    <v-card>
                                        <v-card-title primary-title class="page-head py-4">
                                            ...
                                            Remove Project
                                            <v-spacer></v-spacer>
                                            <v-btn id="AutoTest_IP17" text="" @click="RemoveProjectDailog=false">
                                                <v-icon color="#707070" size="15">mdi-close</v-icon>
                                            </v-btn>
                                        </v-card-title>
                                        <v-card-text class="pt-0">
                                                    ...
                                                    <v-col cols="12" md="12" class="pt-0">
                                                        <v-container fluid class="pt-0">
                                                            <v-row>
                                                                ...
                                                                <v-col>
                                                                    <h4 class="text-center heading-3">
                                                                      <v-avatar color="#fff" size="40" class="mr-2 elevation-1">
                                                                        <v-icon color="#707070" size="25">mdi-file-document-box-minus-outline</v-icon>
                                                                      </v-avatar>
                                                                        {{ProjectName}}
                                                                    </h4>
                                                                ...
                                                                <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                                  <Secondary-Button id="AutoTest_IP18" class="btn-122x36 mr-4" title="Remove" @click.native="DeleteProject(2)"></Secondary-Button>
                                                                  <Default-Button-Outlined id="AutoTest_IP19" class="btn-122x36" title="Cancel" @click.native="RemoveProjectDailog=false"></Default-Button-Outlined>
                                                                </v-col>
                                                            </v-row>
                                                        </v-container>
                                                    </v-col>
                ...
                <v-col cols="12" sm="12" md="12">
                    <v-row :justify="justifyCenter">
                        <v-col md="12" class="text-center">
                            ...
                            <v-btn id="AutoTest_IP20" height="32" color="success-btn" dark class="elevation-0 mr-2" @click="" v-bind:disabled ="!screenAccess">
                                Create project
                            </v-btn>
                        </v-col>
                    </v-row>
            ...
            <v-dialog v-model="IsActiveToggleDialog" width="800">
                <v-card class="elevation-0">
                    <v-card-title primary-title class="page-head py-4">
                        ...
                        Change State
                        <v-spacer></v-spacer>
                        <v-btn id="AutoTest_IP21" text @click="IsActiveToggleDialog=false">
                            <v-icon color="#707070" size="15">mdi-close</v-icon>
                        </v-btn>
                    </v-card-title>
                    <v-card-text class="pt-0">
                                ...
                                <v-col cols="12" md="12" class="pt-0">
                                    <v-container fluid class="pt-0">
                                        <v-row>
                                            ...
                                            <v-col cols="12" xs="12" sm="12" md="12" class="text-right py-0">
                                                <v-btn id="AutoTest_IP22" color="secondary elevation-0" class="mr-2" @click="ChangeState()">Change</v-btn>
                                                <v-btn id="AutoTest_IP23" outlined color="grey" @click="IsActiveToggleDialog=false, GetProjectListByInitID()">Cancel</v-btn>
                                            </v-col>
